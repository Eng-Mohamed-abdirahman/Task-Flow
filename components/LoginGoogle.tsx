...
import { GoogleAuthenticate } from '@/app/actions/Login-google'


const LoginGoogle = () => {

    const [errorMsg , dispatchLogin] = useActionState(GoogleAuthenticate ,null)
   ...
   <form action={dispatchLogin}>
    <Button variant="outline" className="w-full"
            ...
            >
             ...
             {errorMsg && <p className="text-red-500 bg-red-100 border border-red-500 p-4">{errorMsg.error}</p>}
            </Button>
   </form>
  )
}
